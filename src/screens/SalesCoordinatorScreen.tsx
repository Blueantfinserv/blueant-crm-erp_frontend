...
export function SalesCoordinatorScreen({ permissions }: { permissions?: readonly string[] | null }) {
  ...
  return <View style={[styles.page, compact && styles.pageCompact]}>
    ...
    <ScrollView scrollEnabled={tab !== 'tasks'} style={styles.resultsScroll} contentContainerStyle={[styles.resultsContent, tab === 'tasks' && styles.taskResultsContent]} showsVerticalScrollIndicator={false}>
