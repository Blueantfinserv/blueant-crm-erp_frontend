...
export function SalesCoordinatorScreen({ permissions }: { permissions?: readonly string[] | null }) {
  ...
  return <View style={[styles.page, compact && styles.pageCompact]}>
    ...
    <Modal transparent visible={Boolean(historyLead)} animationType="fade" onRequestClose={() => setHistoryLead(null)}><View style={styles.backdrop}><View style={styles.modal}>
      ...
      <ScrollView contentContainerStyle={styles.modalBody}>{historyLead ? <LeadHistoryContentStable lead={historyLead} meetings={historyMeetings} loading={historyLoading} error={historyError} /> : null}</ScrollView>
    </View></View></Modal>
  </View>;
}
...
const historyStyles = StyleSheet.create({
  ...
  meetingStatus: { marginLeft: 'auto', paddingHorizontal: 7, paddingVertical: 3, borderRadius: 99, color: '#A95A08', fontSize: 7, fontWeight: '900', backgroundColor: '#FFF7E8' },
