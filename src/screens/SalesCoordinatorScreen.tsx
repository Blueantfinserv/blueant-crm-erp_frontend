...
const leadCardTone = (lead: LeadResponse) => [...`${lead.assignedByEmployeeCode ?? ''}${lead.assignedEmployeeCode ?? ''}`].reduce((total, character) => total + character.charCodeAt(0), 0) % 4;
...
const styles = StyleSheet.create({
  leadToneBlue: { borderTopColor: '#3156C8', backgroundColor: '#F8FAFF' }, leadToneTeal: { borderTopColor: '#0F8C7F', backgroundColor: '#F3FCFA' }, leadToneViolet: { borderTopColor: '#7C3AED', backgroundColor: '#FAF8FF' }, leadToneAmber: { borderTopColor: '#D97706', backgroundColor: '#FFFBF3' },
  assignedLeadWrap: { gap: 10, padding: 12 }, coordinatorFilterCard: { flexDirection: 'row', alignItems: 'center', gap: 9, padding: 9, borderWidth: 1, borderColor: '#D8E3FB', borderRadius: 12, backgroundColor: '#F6F8FF' }, coordinatorFilterIcon: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderRadius: 10, backgroundColor: '#E3EBFF' }, coordinatorFilterCopy: { minWidth: 0, flex: 1 }, coordinatorFilterTitle: { color: '#1E3A8A', fontSize: 11, fontWeight: '900' }, coordinatorFilterHint: { marginTop: 2, color: '#71809A', fontSize: 8, fontWeight: '700' }, coordinatorPicker: { width: 220, height: 40, overflow: 'hidden', borderWidth: 1, borderColor: '#C7D2FE', borderRadius: 9, backgroundColor: '#FFFFFF' }, coordinatorPickerDisabled: { opacity: 0.5, backgroundColor: '#F1F5F9' }, assignedLeadGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, assignedLeadCard: { width: '31%', minWidth: 250, flexGrow: 1, gap: 8, padding: 11, borderWidth: 1, borderTopWidth: 3, borderTopColor: '#3156C8', borderColor: '#DCE3ED', borderRadius: 12, backgroundColor: '#FFFFFF', shadowColor: '#0F172A', shadowOpacity: 0.05, shadowRadius: 7, shadowOffset: { width: 0, height: 3 }, elevation: 2 }, assignedLeadTop: { flexDirection: 'row', alignItems: 'center', gap: 8 }, assignedLeadAvatar: { width: 31, height: 31, alignItems: 'center', justifyContent: 'center', borderRadius: 10, backgroundColor: '#E8EEFF' }, assignedLeadAvatarText: { color: '#3156C8', fontSize: 11, fontWeight: '900' }, assignedLeadCopy: { minWidth: 0, flex: 1 }, assignedLeadName: { color: '#172554', fontSize: 11, fontWeight: '900' }, assignedLeadMeta: { marginTop: 3, color: '#71809A', fontSize: 8, fontWeight: '700' }, assignedLeadValue: { marginTop: 3, color: '#1E293B', fontSize: 9, fontWeight: '900' }, assignedLeadDivider: { height: 1, backgroundColor: '#E8EDF4' }, assignedLeadDetails: { flexDirection: 'row', justifyContent: 'space-between', gap: 8 }, leadStatusPill: { paddingHorizontal: 8, paddingVertical: 5, borderRadius: 99, backgroundColor: '#FFF7E8' }, leadStatusPillText: { color: '#A95A08', fontSize: 7, fontWeight: '900' },
