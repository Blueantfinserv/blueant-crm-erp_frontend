    ...
    <View style={styles.contentPanel}>
      <View style={styles.contentHeading}>
        <View style={styles.contentHeadingRow}>
          ...
          {tab === 'responses' ? <TextInput value={responseSearch} onChangeText={setResponseSearch} placeholder="Search lead name or number" placeholderTextColor="#CBD9FF" style={styles.headerSearch} /> : null}
