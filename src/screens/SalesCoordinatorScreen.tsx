  ...
  return <View style={[styles.page, compact && styles.pageCompact]}>
    ...
    {!loading && !error && tab === 'tasks' ? <View style={styles.taskSection}>
      ...
      <View style={styles.taskList}>
        {!compact ? <MeetingTableHeader records={taskMeetings} filters={taskColumnFilters} onFiltersChange={setTaskColumnFilters} /> : null}
