...
const leadCardTone = (lead: LeadResponse) => [...String(lead.leadCode ?? lead.leadId ?? '')].reduce((total, character) => total + character.charCodeAt(0), 0) % 4;
...
const styles = StyleSheet.create({
  leadToneBlue: { borderTopColor: '#3156C8', backgroundColor: '#F0F4FF' }, leadToneTeal: { borderTopColor: '#0F8C7F', backgroundColor: '#EAF9F5' }, leadToneViolet: { borderTopColor: '#7C3AED', backgroundColor: '#F5F0FF' }, leadToneAmber: { borderTopColor: '#D97706', backgroundColor: '#FFF6E8' },
