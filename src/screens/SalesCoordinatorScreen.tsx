...
const styles = StyleSheet.create({
  ...
  taskFullPanel: { gap: 10, padding: 10 }, taskToolbar: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 7, padding: 10, borderWidth: 1, borderColor: '#DCE5FA', borderRadius: 10, backgroundColor: '#F8FAFF' }, taskToolbarHeader: { minWidth: 0, flex: 1, justifyContent: 'flex-end', padding: 0, borderWidth: 0, borderRadius: 0, backgroundColor: 'transparent' }, taskSalesPicker: { width: 190, height: 34, flexDirection: 'row', alignItems: 'center', gap: 3, paddingLeft: 8, overflow: 'hidden', borderWidth: 1, borderColor: '#D4E0FF', borderRadius: 10, backgroundColor: '#F9FBFF' }, taskSalesPickerControl: { minWidth: 0, flex: 1, height: 34, color: '#1E3A8A', fontSize: 9, fontWeight: '900' }, taskSummaryPanelCompact: { width: '100%' }, taskResultsContent: { flex: 1, minHeight: 0 }, taskDashboardFill: { flex: 1, minHeight: 0 }, taskListFill: { flex: 1, minHeight: 0 }, taskRowsScroll: { flex: 1, minHeight: 0 }, taskRowsContent: { flexGrow: 0 },
