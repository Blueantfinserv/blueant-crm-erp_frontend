...
const styles = StyleSheet.create({
  headerLeadFilters: { flexDirection: 'row', gap: 8 }, headerLeadFilter: { height: 36, flexDirection: 'row', alignItems: 'center', gap: 5, paddingLeft: 8, borderWidth: 1, borderColor: 'rgba(191,209,255,0.42)', borderRadius: 9, backgroundColor: 'rgba(255,255,255,0.08)' }, headerLeadPicker: { width: 174, height: 34, overflow: 'hidden', borderRadius: 7, backgroundColor: '#FFFFFF' }, headerLeadPickerDisabled: { opacity: 0.5 }, headerLeadPickerControl: { height: 34, color: '#1E3A8A', fontSize: 9, fontWeight: '800' },
