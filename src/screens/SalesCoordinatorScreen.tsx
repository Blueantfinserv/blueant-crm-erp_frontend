...
export function SalesCoordinatorScreen({ permissions }: { permissions?: readonly string[] | null }) {
  ...
  return <View style={[styles.page, compact && styles.pageCompact]}>
    ...
    <Modal transparent visible={Boolean(historyLead)} animationType="fade" onRequestClose={() => setHistoryLead(null)}><View style={styles.backdrop}><View style={styles.modal}>
      ...
      <ScrollView contentContainerStyle={styles.modalBody}>{historyLead ? <LeadHistoryContent lead={historyLead} meetings={historyMeetings} loading={historyLoading} error={historyError} /> : null}</ScrollView>
    </View></View></Modal>
  </View>;
}
...
const styles = StyleSheet.create({
  ...
  detailsWrap: { gap: 11 }, historyWrap: { gap: 10 }, historyTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, historyCount: { color: '#64748B', fontSize: 9, fontWeight: '800' }, timeline: { gap: 0 }, timelineItem: { flexDirection: 'row', minHeight: 92 }, timelineRail: { width: 24, alignItems: 'center' }, timelineDot: { width: 11, height: 11, marginTop: 12, borderRadius: 6, backgroundColor: '#3156C8', borderWidth: 3, borderColor: '#DBEAFE' }, timelineLine: { width: 2, flex: 1, marginVertical: 3, backgroundColor: '#D6E1F7' }, timelineCard: { minWidth: 0, flex: 1, gap: 4, marginBottom: 10, padding: 10, borderWidth: 1, borderColor: '#DCE5F3', borderRadius: 10, backgroundColor: '#F8FAFF' }, timelineTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, timelineTitle: { minWidth: 0, flex: 1, color: '#1E3A8A', fontSize: 11, fontWeight: '900' }, timelineStatus: { maxWidth: '46%', paddingHorizontal: 7, paddingVertical: 3, overflow: 'hidden', borderRadius: 99, color: '#A95A08', fontSize: 7, fontWeight: '900', backgroundColor: '#FFF7E8' }, timelineMeta: { color: '#64748B', fontSize: 8, fontWeight: '700' }, timelineValue: { color: '#334155', fontSize: 9, fontWeight: '600', lineHeight: 13 },
