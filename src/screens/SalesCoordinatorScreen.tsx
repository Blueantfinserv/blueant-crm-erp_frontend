...
const styles = StyleSheet.create({
  ...
  clearFilters: { width: 82, minHeight: 26, alignItems: 'center', justifyContent: 'center', borderRadius: 7, backgroundColor: '#DC2626' },
  clearFiltersText: { color: '#FFFFFF', fontSize: 8, fontWeight: '900' },
