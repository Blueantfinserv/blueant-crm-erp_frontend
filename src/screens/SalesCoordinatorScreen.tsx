...
const styles = StyleSheet.create({
  ...
  pickerShell: { height: 42, justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: '#D4DCE8', borderRadius: 10, backgroundColor: '#FFFFFF', shadowColor: '#0F172A', shadowOpacity: 0.035, shadowRadius: 4, shadowOffset: { width: 0, height: 1 }, elevation: 1 },
  picker: { height: 42, color: '#1F2937', fontSize: 11, fontWeight: '600' },
