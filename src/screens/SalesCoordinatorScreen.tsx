...
export function SalesCoordinatorScreen({ permissions }: { permissions?: readonly string[] | null }) {
  ...
  return <View style={[styles.page, compact && styles.pageCompact]}>
    ...
    <ScrollView scrollEnabled={tab !== 'tasks'} style={styles.resultsScroll} contentContainerStyle={styles.resultsContent} showsVerticalScrollIndicator={false}>
...
const styles = StyleSheet.create({
  ...
  taskSummaryPanelCompact: { width: '100%' }, taskDashboardFill: { flex: 1, minHeight: 0 }, taskListFill: { flex: 1, minHeight: 0 }, taskRowsScroll: { flex: 1, minHeight: 0 },
